...
def run():
    ...
    # Replace '/full/path/to/' with the actual path to the directory containing the image
    img_path = os.path.join('E:/xampp/htdocs/Smart_Resume_Analyser_App-master/Smart_Resume_Analyser_App-master/Logo/SRA_Logo.jpg', 'Logo', 'SRA_Logo.jpg')
    img = Image.open('E:/xampp/htdocs/Smart_Resume_Analyser_App-master/Smart_Resume_Analyser_App-master/Logo/SRA_Logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            #     time.sleep(4)
            save_image_path = 'E:/xampp/htdocs/Smart_Resume_Analyser_App-master/Smart_Resume_Analyser_App-master/Uploaded_Resumes' + pdf_file.name
            with open(save_image_path, "wb") as f:
                f.write(pdf_file.getbuffer())
            show_pdf(save_image_path)
            resume_data = ResumeParser('E:/xampp/htdocs/Smart_Resume_Analyser_App-master/Smart_Resume_Analyser_App-master/Uploaded_Resumes' + pdf_file.name).get_extracted_data()
            if resume_data:
        ...
        if st.button('Login'):
            if ad_user == 'TECHLIGHT' and ad_password == 'techlight03':
                st.success("Welcome Team Techlight")
                # Display Data
